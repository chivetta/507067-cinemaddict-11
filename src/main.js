...
const getTemplateOfUserStatistic = () => (
...
const getTemplateOfMainContent = () => (
  `<section class="films"></section>`
);

const getTemplateOfFilmsList = () => (
  `<section class="films-list">
    <h2 class="films-list__title visually-hidden">All movies. Upcoming</h2>
  </section>`
);

const getTemplateOfLoadButton = () => (
...
const getTemplateOfCardsContainer = () => (
  `<div class="films-list__container"></div>`
);

const getTemplateOfCard = () => (
